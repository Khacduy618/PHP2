...
<?php
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            ...
            <?php
                if($product_id > 6){
            ?><a class="product-pager-link product-pager-prev" href="<?php echo _WEB_ROOT; ?>/product-detail/<?=$product_id - 1?>"
            ...
            ?>
                ...
                <a class="product-pager-link product-pager-next" href="<?php echo _WEB_ROOT; ?>/product-detail/<?=$product_id + 1?>" aria-label="Next" tabindex="-1">
                    <span>Next</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            <h1 class="product-title"><?=$product_name?></h1><!-- End .product-title -->
