...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/favicon-16x16.png">
    <link rel="manifest" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/site.html">
    <link rel="mask-icon" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/safari-pinned-tab.svg" color="#666666">
    <link rel="shortcut icon" href="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Molla">
    <meta name="application-name" content="Molla">
    <meta name="msapplication-TileColor" content="#cc9966">
    <meta name="msapplication-config" content="<?php echo _WEB_ROOT; ?>/public/assets/site/images/icons/browserconfig.xml">
    ...
    <link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/site/css/plugins/jquery.countdown.css">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="<?php echo _WEB_ROOT; ?>/public/assets/site/css/style.css">
...
<body>
    ...
    <script src="<?php echo _WEB_ROOT; ?>/public/assets/site/js/jquery.hoverIntent.min.js"></script>
    <script src="<?php echo _WEB_ROOT; ?>/public/assets/site/js/jquery.waypoints.min.js"></script>
    ...
    <script src="<?php echo _WEB_ROOT; ?>/public/assets/site/js/demos/demo-3.js"></script>
</body>
